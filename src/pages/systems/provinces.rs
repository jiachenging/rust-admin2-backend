...
use lucky::{
    json::JsonPager,
    models::{ProvinceRow as ModelRow},
    types::SwapData,
    web::{FetchMsg, Api},
    html::DataTable,
};

const API_LIST: &'static str = "/provinces";
const API_CACHE_KEY: &'static str = "provinces";
...
impl DataTable for Provinces {}

impl Component for Provinces {
    ...
    fn view(&self) -> VNode {
        ...
        render_view!("/systems/provinces.html")
    }
}
